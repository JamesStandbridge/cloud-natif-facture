...
import com.cesi.goodfood.IntegrationTest;
...
class FactureResourceIT {
    ...
    public static Facture createEntity(EntityManager em) {
        Facture facture = new Facture().montant(DEFAULT_MONTANT);
        return facture;
    }
    ...
    public static Facture createUpdatedEntity(EntityManager em) {
        Facture facture = new Facture().montant(UPDATED_MONTANT);
        return facture;
    }
    ...
    void putNewFacture() throws Exception {
        ...
        updatedFacture.montant(UPDATED_MONTANT);
