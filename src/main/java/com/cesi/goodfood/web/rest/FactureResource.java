package com.cesi.goodfood.web.rest;

import com.cesi.goodfood.domain.Facture;
import com.cesi.goodfood.repository.FactureRepository;
import com.cesi.goodfood.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.cesi.goodfood.domain.Facture}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class FactureResource {
    ...
    private static final String ENTITY_NAME = "factureFacture";
